...
results <- try(readRDS(paste0("./Runs_results/results_Pin_syl.rds")))
...
for(i in 1:nrow(sites)){
  ...
  parameter_name = paste0("Pin_syl_",sites[i,"Longitudinal"],"_",sites[i,"Latitudinal"],".rds")
  ...
  parameters <- GetRunAbleParameters(defaultparameters = defaultparameters, PFTs = c("Pin_syl"))
